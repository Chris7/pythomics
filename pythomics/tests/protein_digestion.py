...
class Test_Protein_Digestion(unittest.TestCase):
    ...
    def setUp(self):
        self.handle = 'fasta_iterator.fasta'
    ...
    def test_protein_digestion(self):
        ...
        peptides = ''.join(enzyme.cleave(out, min=0,max=9999))
        hash_sum = hashlib.sha224(peptides).hexdigest()
        self.assertEqual( '2b5e17ce606e9a296095d8b4b9cf75d44ba662d5eb3531e0a187def4', hash_sum, "Protein Digestion with Lys-C Failure")
