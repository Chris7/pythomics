...
class Test_Script_Fasta_Digest(unittest.TestCase):
    ...
    def test_fasta_genome_digest(self):
        job = subprocess.Popen(['../scripts/fastadigest.py', '-f', 'nucleotide.fasta', '--genome', 'True', '--min', '0',
        ...
        job = subprocess.Popen(['../scripts/fastadigest.py', '-f', 'nucleotide.fasta', '--genome', 'True', '--min', '6',
    ...
    def test_fasta_protein_digest(self):
        job = subprocess.Popen(['../scripts/fastadigest.py', '-f', 'fasta_iterator.fasta', '--min', '0',
        ...
        job = subprocess.Popen(['../scripts/fastadigest.py', '-f', 'fasta_iterator.fasta', '--min', '6',
