...
parser.add_out()
parser.add_argument(
    "--min", help="Minimum ORF length in amino acids.", type=int, default=50
)
parser.add_argument(
    "--both-strands", help="Search both strands for ORFs.", action="store_true"
)
parser.add_argument(
    "--no-met-start",
...
parser.add_argument(
    "--from-met", help="Truncate leading amino acids up to MET", action="store_true"
)
parser.add_argument(
    "--from-met-keep",
